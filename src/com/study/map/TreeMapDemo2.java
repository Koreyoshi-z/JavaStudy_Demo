...
class Person2 /*implements Comparable<com.study.map.Person2>*/{//实现Comparable接口，重写compareTo方法
    private String name;
    private int age;
    ...
    /*
    @Override
    public int compareTo(com.study.map.Person2 o) {
