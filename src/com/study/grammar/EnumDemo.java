...
enum Person1{
    ...
    //上面的语句相当于
    //public static final com.study.innerclass.Person P1 = new Person2("张三",23);
    //public static final com.study.innerclass.Person P2 = new Person2("张三",23);
    //public static final com.study.innerclass.Person P3 = new Person2("张三",23);
    ...
    @Override
    public String toString() {
        return "com.study.innerclass.Person{" +
                "name='" + name + '\'' +
                ", age=" + age +
                '}';
    }
